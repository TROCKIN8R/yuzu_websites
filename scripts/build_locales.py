...
INDEX_FR: list[tuple[str, str]] = [
    ...
    # Nav
    ('<a href="#vision" class="nav-pill-item">Vision</a>', '<a href="#vision" class="nav-pill-item">Vision</a>'),
    ("Services <span class=\"nav-chevron\">▾</span>", "Services <span class=\"nav-chevron\">▾</span>"),
    ('<a href="#founder" class="nav-pill-item">Our Team</a>', '<a href="#founder" class="nav-pill-item">Notre équipe</a>'),
    ('<a href="#services" class="md:hidden text-sm font-semibold hover:text-yellow-600">Services</a>',
     '<a href="#services" class="md:hidden text-sm font-semibold hover:text-yellow-600">Services</a>'),
    ('<a href="#founder" class="md:hidden text-sm font-semibold hover:text-yellow-600">Our Team</a>',
     '<a href="#founder" class="md:hidden text-sm font-semibold hover:text-yellow-600">Notre équipe</a>'),
    ...
    ("If life gives you <span class=\"text-yellow-500\">Yuzu</span>,<br>\n                <span class=\"hero-rotate\" data-phrases=\"extract| it!,transform| it!,load| it!,automate| it!,AI| it?\">\n                    <span class=\"hero-rotate-slot\"><span class=\"hero-rotate-line\"><span class=\"hero-rotate-word text-lime-600\">extract</span><span class=\"hero-rotate-suffix\"> it!</span></span></span>\n                </span>\n            </h1>\n            <span id=\"hero-rotate-live\" class=\"hero-rotate-live\" aria-live=\"polite\" aria-atomic=\"true\">extract it!</span>",
     "Si la vie te donne du <span class=\"text-yellow-500\">yuzu</span>,<br>\n                <span class=\"hero-rotate\" data-phrases=\"extrais-le| !,transforme-le| !,charge-le| !,automatise-le| !,AI| it?\">\n                    <span class=\"hero-rotate-slot\"><span class=\"hero-rotate-line\"><span class=\"hero-rotate-word text-lime-600\">extrais-le</span><span class=\"hero-rotate-suffix\"> !</span></span></span>\n                </span>\n            </h1>\n            <span id=\"hero-rotate-live\" class=\"hero-rotate-live\" aria-live=\"polite\" aria-atomic=\"true\">extrais-le !</span>"),
    ...
    # Vision — Extracting Value
    (">🍋 Our Vision</span>", ">🍋 Notre vision</span>"),
    ('Extracting <span class="text-yellow-500">Value</span>',
     'Extraire la <span class="text-yellow-500">valeur</span>'),
    ("Raw data is just a crate of lemons. Our vision is simple — extract what matters, refine it until it's clear, and serve it in a glass you actually want to drink. That's ETL, the Yuzu way.",
     "Les données brutes ne sont qu'une caisse de citrons. Notre vision est simple — extraire l'essentiel, le raffiner jusqu'à ce qu'il soit limpide, et le servir dans un verre qu'on a vraiment envie de boire. C'est l'ETL, à la façon Yuzu."),
    (">Extract</span>", ">Extraire</span>"),
    ('E</span> Extract</p>', 'E</span> Extraire</p>'),
    ('T</span> Transform</p>', 'T</span> Transformer</p>'),
    ('L</span> Load</p>', 'L</span> Charger</p>'),
    (">Squeeze the lemons</h3>", ">Presser les citrons</h3>"),
    ("We pull raw data from every source — databases, APIs, spreadsheets, that one crusty legacy system. Every lemon goes into the press. Nothing useful left behind.",
     "On extrait les données brutes de chaque source — bases de données, API, feuilles de calcul, et ce vieux système legacy. Chaque citron passe au pressoir. Rien d'utile n'est laissé de côté."),
    (">Transform</span>", ">Transformer</span>"),
    (">Filter, blend &amp; sweeten</h3>", ">Filtrer, mélanger et sucrer</h3>"),
    ("Pulp out, sugar in. We clean, filter, join and reshape the raw juice — fixing types, killing duplicates, and adding the business logic that makes it actually taste good.",
     "La pulpe sort, le sucre entre. On nettoie, filtre, joint et remodèle le jus brut — on corrige les types, élimine les doublons et ajoute la logique d'affaires qui lui donne vraiment bon goût."),
    (">Load</span>", ">Charger</span>"),
    (">Serve it in the perfect glass</h3>", ">Servir dans le verre parfait</h3>"),
    ("The finished juice is poured into a polished glass — a governed warehouse and dashboards your team can drink from. Clear, fresh, and ready for decisions.",
     "Le jus fini est versé dans un verre soigné — un entrepôt gouverné et des tableaux de bord où votre équipe peut puiser. Limpide, frais et prêt pour la décision."),
    (">♻️ Always Fresh</span>", ">♻️ Toujours frais</span>"),
    ("ETL is refreshing. Automated, it's a fountain that never runs dry.",
     "L'ETL, c'est rafraîchissant. Automatisé, c'est une fontaine qui ne se tarit jamais."),
    ("Squeezing by hand is fine once. But the real magic is a machine that does it for you — pipelines that refresh themselves on schedule, every morning, while you sleep. No manual squeezing. Just value on tap.",
     "Presser à la main, ça va une fois. Mais la vraie magie, c'est une machine qui le fait pour vous — des pipelines qui se rafraîchissent tout seuls, selon l'horaire, chaque matin, pendant que vous dormez. Aucune pression manuelle. Juste de la valeur au robinet."),
    # Impact
    ...
    ("🍋 For the ones always looking for numbers", "🍋 Pour ceux qui cherchent toujours les chiffres"),
    # Process
    ...
    ('<h2 class="section-title">Our Team</h2>', '<h2 class="section-title">Notre équipe</h2>'),
    ('<a href="#founder" class="mobile-nav-link">Our Team</a>', '<a href="#founder" class="mobile-nav-link">Notre équipe</a>'),
    ('<li><a href="#founder">Our Team</a></li>', '<li><a href="#founder">Notre équipe</a></li>'),
    ...
    # Footer
    ("Powered by yuzu, ETL, and the courage to finally delete that 47-tab spreadsheet.",
     "Propulsé par le yuzu, l'ETL et le courage de supprimer enfin ce classeur à 47 onglets."),
...
INDEX_ES: list[tuple[str, str]] = [
    ...
    ('<a href="#founder" class="nav-pill-item">Our Team</a>', '<a href="#founder" class="nav-pill-item">Nuestro equipo</a>'),
    ('<a href="#founder" class="md:hidden text-sm font-semibold hover:text-yellow-600">Our Team</a>',
     '<a href="#founder" class="md:hidden text-sm font-semibold hover:text-yellow-600">Nuestro equipo</a>'),
    ...
    ("If life gives you <span class=\"text-yellow-500\">Yuzu</span>,<br>\n                <span class=\"hero-rotate\" data-phrases=\"extract| it!,transform| it!,load| it!,automate| it!,AI| it?\">\n                    <span class=\"hero-rotate-slot\"><span class=\"hero-rotate-line\"><span class=\"hero-rotate-word text-lime-600\">extract</span><span class=\"hero-rotate-suffix\"> it!</span></span></span>\n                </span>\n            </h1>\n            <span id=\"hero-rotate-live\" class=\"hero-rotate-live\" aria-live=\"polite\" aria-atomic=\"true\">extract it!</span>",
     "Si la vida te da <span class=\"text-yellow-500\">yuzu</span>,<br>\n                <span class=\"hero-rotate\" data-phrases=\"¡:extráelo|!,¡:transfórmalo|!,¡:cárgalo|!,¡:automatízalo|!,¿:AI| it?\">\n                    <span class=\"hero-rotate-slot\"><span class=\"hero-rotate-line\"><span class=\"hero-rotate-prefix\">¡</span><span class=\"hero-rotate-word text-lime-600\">extráelo</span><span class=\"hero-rotate-suffix\">!</span></span></span>\n                </span>\n            </h1>\n            <span id=\"hero-rotate-live\" class=\"hero-rotate-live\" aria-live=\"polite\" aria-atomic=\"true\">¡extráelo!</span>"),
    (">We turn raw, complex data into refreshing, automated insights.</p>",
    ...
    # Vision — Extracting Value
    (">🍋 Our Vision</span>", ">🍋 Nuestra visión</span>"),
    ('Extracting <span class="text-yellow-500">Value</span>',
     'Extraer <span class="text-yellow-500">valor</span>'),
    ("Raw data is just a crate of lemons. Our vision is simple — extract what matters, refine it until it's clear, and serve it in a glass you actually want to drink. That's ETL, the Yuzu way.",
     "Los datos crudos son solo una caja de limones. Nuestra visión es simple — extraer lo que importa, refinarlo hasta que quede claro y servirlo en un vaso que de verdad quieras beber. Eso es ETL, al estilo Yuzu."),
    (">Extract</span>", ">Extraer</span>"),
    ('E</span> Extract</p>', 'E</span> Extraer</p>'),
    ('T</span> Transform</p>', 'T</span> Transformar</p>'),
    ('L</span> Load</p>', 'L</span> Cargar</p>'),
    (">Squeeze the lemons</h3>", ">Exprimir los limones</h3>"),
    ("We pull raw data from every source — databases, APIs, spreadsheets, that one crusty legacy system. Every lemon goes into the press. Nothing useful left behind.",
     "Extraemos datos crudos de cada fuente — bases de datos, APIs, hojas de cálculo y ese viejo sistema legacy. Cada limón va a la prensa. Nada útil se queda atrás."),
    (">Transform</span>", ">Transformar</span>"),
    (">Filter, blend &amp; sweeten</h3>", ">Filtrar, mezclar y endulzar</h3>"),
    ("Pulp out, sugar in. We clean, filter, join and reshape the raw juice — fixing types, killing duplicates, and adding the business logic that makes it actually taste good.",
     "La pulpa fuera, el azúcar dentro. Limpiamos, filtramos, unimos y reformamos el jugo crudo — corrigiendo tipos, eliminando duplicados y añadiendo la lógica de negocio que lo hace saber bien de verdad."),
    (">Load</span>", ">Cargar</span>"),
    (">Serve it in the perfect glass</h3>", ">Servirlo en el vaso perfecto</h3>"),
    ("The finished juice is poured into a polished glass — a governed warehouse and dashboards your team can drink from. Clear, fresh, and ready for decisions.",
     "El jugo terminado se sirve en un vaso pulido — un almacén gobernado y dashboards de los que tu equipo puede beber. Claro, fresco y listo para decidir."),
    (">♻️ Always Fresh</span>", ">♻️ Siempre fresco</span>"),
    ("ETL is refreshing. Automated, it's a fountain that never runs dry.",
     "El ETL es refrescante. Automatizado, es una fuente que nunca se seca."),
    ("Squeezing by hand is fine once. But the real magic is a machine that does it for you — pipelines that refresh themselves on schedule, every morning, while you sleep. No manual squeezing. Just value on tap.",
     "Exprimir a mano está bien una vez. Pero la verdadera magia es una máquina que lo hace por ti — pipelines que se actualizan solos, según el horario, cada mañana, mientras duermes. Sin exprimir a mano. Solo valor del grifo."),
    ...
    ("🍋 For the ones always looking for numbers", "🍋 Para los que siempre buscan números"),
    (">How We Work <span class=\"text-gray-400 font-normal text-3xl\">(The Squeeze)</span></h2>",
    ...
    ('<h2 class="section-title">Our Team</h2>', '<h2 class="section-title">Nuestro equipo</h2>'),
    ('<a href="#founder" class="mobile-nav-link">Our Team</a>', '<a href="#founder" class="mobile-nav-link">Nuestro equipo</a>'),
    ('<li><a href="#founder">Our Team</a></li>', '<li><a href="#founder">Nuestro equipo</a></li>'),
    ("One senior specialist, zero middlemen, and a serious grudge against zest-less dashboards.",
    ...
    ("Powered by yuzu, ETL, and the courage to finally delete that 47-tab spreadsheet.",
     "Impulsado por yuzu, ETL y el valor de borrar por fin esa hoja de cálculo de 47 pestañas."),
    ("© 2026 Yuzu.solutions · Extracting answers. Automating the grind.",
     "© 2026 Yuzu.solutions · Exprimimos respuestas. Automatizamos el trabajo pesado."),
    (">Explore</h2>", ">Explorar</h2>"),
    (">Recipes</h2>", ">Recetas</h2>"),
...
SERVICE_NAV_FR: list[tuple[str, str]] = [
    ('<a href="../index.html#founder" class="nav-pill-item">Our Team</a>',
     '<a href="../index.html#founder" class="nav-pill-item">Notre équipe</a>'),
    ('<a href="../index.html#founder" class="md:hidden text-sm font-semibold hover:text-yellow-600">Our Team</a>',
     '<a href="../index.html#founder" class="md:hidden text-sm font-semibold hover:text-yellow-600">Notre équipe</a>'),
    ('<a href="../index.html#founder" class="mobile-nav-link">Our Team</a>',
     '<a href="../index.html#founder" class="mobile-nav-link">Notre équipe</a>'),
    ('>Get Started</a>', '>Commencer</a>'),
...
SERVICE_NAV_ES: list[tuple[str, str]] = [
    ('<a href="../index.html#founder" class="nav-pill-item">Our Team</a>',
     '<a href="../index.html#founder" class="nav-pill-item">Nuestro equipo</a>'),
    ('<a href="../index.html#founder" class="md:hidden text-sm font-semibold hover:text-yellow-600">Our Team</a>',
     '<a href="../index.html#founder" class="md:hidden text-sm font-semibold hover:text-yellow-600">Nuestro equipo</a>'),
    ('<a href="../index.html#founder" class="mobile-nav-link">Our Team</a>',
     '<a href="../index.html#founder" class="mobile-nav-link">Nuestro equipo</a>'),
    ('>Get Started</a>', '>Empezar</a>'),
