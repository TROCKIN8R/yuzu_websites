...
echo ""
echo "Required Edge Function secrets (Dashboard → Edge Functions → Secrets):"
...
echo "  1) scripts/supabase_study_permit_drafts.sql"
echo "  2) scripts/supabase_revoke_study_permit_drafts.sql"
