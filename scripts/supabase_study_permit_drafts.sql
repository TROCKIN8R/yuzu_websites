...
-- Draft saves for the study-permit kit (service role only).
-- Resume requires secret code + family name / last name (hashes stored).
-- Form answers are AES-GCM encrypted in payload (Edge Function encrypts/decrypts).
